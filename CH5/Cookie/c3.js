...
// form & Create a link to display this feedback details stored in the "feedback"
...
app.get('/submit-feedback', (req, res) => {
    const feedbackData = req.query; 
    res.cookie('feedback', feedbackData, { maxAge: 10000 });
    res.send(`
        <h3>Confirmation: Feedback submitted!</h3>
...
app.get('/view-feedback', (req, res) => {
    ...
    if (feedback) {
        ...
        res.send("<h3>no feedback available</h3><a href='/'>Back to Home</a>");
    }
});
